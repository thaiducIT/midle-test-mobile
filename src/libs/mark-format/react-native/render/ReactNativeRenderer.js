...
/*
  Text tạm thời được import vào đây, tuy nhiên thì nó sẽ hoạt động đúng với project này.
...
ReactNativeRenderer.prototype.renderNode = function(renderer) {
  ...
  return function({
    ...
    // Do trong Text chỉ mới setup font size và font weigh, mấy thứ khác chưa setup.
    ...
    switch(ftts.format) {
      ...
      case LINK_TYPE: {
        ele = <Text key={_id} hyperLink={url}>{eleChildren}</Text>
        break;
      };
